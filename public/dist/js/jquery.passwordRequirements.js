    ...
    $.fn.extend({
        passwordRequirements: function(options) {
            ...
            return this.each(function() {
                ...
                o.infoMessage = 'The minimum password length is ' + o.numCharacters + ' characters and must contain at least 1 capital letter and 1 special character.';
				// Add Variables for the li elements
				var numCharactersUI = '<li class="pr-numCharacters"><span></span>6 characters</li>',
					useLowercaseUI = '',
					useUppercaseUI = '',
					useNumbersUI   = '',
					useSpecialUI   = '';

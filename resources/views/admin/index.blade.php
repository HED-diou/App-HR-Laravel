                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                        <span class="txt-light block counter"><span class="counter-anim">{{$total['0']->sum}}</span> days</span>
                                        <span class="weight-500 uppercase-font txt-light block">Total balance</span>
                                    </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div style="margin-bottom: 35px" class=" col-lg-12 col-xs-12 text-center pl-0 pr-0 data-wrap-left ">
                                        <span class="txt-light block counter">Last <span class="counter-anim">05 </span> requests being processed</span>
                                               ...
                                               <span style="; margin: auto" class=" weight-500  txt-light block ">
                                                    <ul >
                                                           @foreach($requests as $request)
                                                            <li class="request-dash clicked" onclick="modalfunc({{ $request->request_id }})">
                                                                             {{$request->requesterfn}} {{$request->requesterln}} : {{$request->start_date}}  --> {{$request->end_date}}    , {{$request->name}}.
                                                                        </li>
                                                        @endforeach
                                                                      <li>
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: [
                    ...
                    @foreach($empcongs as $empcong)
                {
                    ...
                    title:'{{$empcong->requesterln}} {{$empcong->requesterfn}}',

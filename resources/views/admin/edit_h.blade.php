                                            ...
                                            <div class="panel-wrapper collapse in">
                                                <div class="panel-body pa-0">
                                                    <div class="col-sm-12 col-xs-12">
                                                        <div class="form-wrap">
                                                            <form action="/admin/candidat/update_h/{{$hobies->id}}" name="myForm" method="POST" autocomplete="off">
                                                                @csrf
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input value="{{$hobies->name}}" type="text" oninvalid="InvalidMssg(this);" oninput="InvalidMssg(this);"  required="required" class="form-control"  id="Hobie" name="Hobie" placeholder="Hobie name" value="{{ old('Hobie') }}" autocomplete="Hobie" autofocus>
